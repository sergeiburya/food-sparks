...
//                .andExpect(MockMvcResultMatchers.jsonPath("$.productAmount[0].productId")
//                        .value(22))
//                .andExpect(MockMvcResultMatchers.jsonPath("$.productAmount[0].name")
//                        .value("Wood"))
//                .andExpect(MockMvcResultMatchers.jsonPath("$.productAmount[0].quantity")
//                        .value(5))
//                .andExpect(MockMvcResultMatchers.jsonPath("$.productAmount[0].productSum")
//                        .value(225));
//    }
//
//    @Test
...
//
//        Mockito.when(userService.findByEmail(email)).thenReturn(Optional.of(bob));
//        Mockito.when(shoppingCartService.increaseProductAmount(bread.getId(), bob))
//                .thenReturn(bobShopCard);
//
//        UserPrincipal userPrincipal = new UserPrincipal(bob.getEmail());
//        Authentication authentication = Mockito.mock(Authentication.class);
//        Mockito.when(authentication.getPrincipal()).thenReturn(userPrincipal);
//
//        mockMvc.perform(MockMvcRequestBuilders.put("/shopping-cart/increase?email=" + email)
